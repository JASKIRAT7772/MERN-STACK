...
class Person extends Component {
  state ={
      infos: [
      { name: 'Jaskirat', birthday:'15 January 1998', aboutMe:'I love playing Football', id: 1 },
      { name: 'Pulkit', birthday:'12 May 1998', aboutMe:'I love to Dance', id: 2 }
    ]
  }
  deleteInfo = (id)=>{
      //console.log(id);
  ...
  render(){
      return (
        <div className="App container">
          <h4 className="center purple-text">Information</h4>
